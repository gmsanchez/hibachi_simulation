...
def generate_launch_description():
    ...
    empty_world = PathJoinSubstitution([FindPackageShare("hibachi_gz"), "worlds", "empty_world.world"],)
    ...
    gz_resource_path = AppendEnvironmentVariable(
        ...
        PathJoinSubstitution([FindPackageShare("hibachi_gz"), "models"]),
    )
    ...
    # Delay start of `joint_state_broadcaster` after spawn_hibachi_entity
    # delay_joint_state_broadcaster_after_hibachi_entity = RegisterEventHandler(
    #     event_handler=OnProcessExit(
    #         target_action=spawn_hibachi_joint_state_broadcaster,
    #         on_exit=[spawn_hibachi_entity],
    #     )
    # )
    ...
    #     event_handler=OnProcessExit(
    #         target_action=spawn_hibachi_entity,
    ...
    gz_bridge = Node(
        ...
        arguments=['/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock',
                   ...
                   '/mti_630_8A1G6/imu/data_raw@sensor_msgs/msg/Imu@gz.msgs.IMU',
    ...
    ld.add_action(spawn_hibachi_entity)
